<footer>
            <div class="container">
                ...
                <section id="contact">
                	<h3>
                		<h3>Untuk pemesanaan hubungi 0341-299-5599. Anda dapat <br> mengirim email ke alamat
                		<a href="mailto:infokarismaacademy.com">info@karismaacademy.com</a>
                	</h3>
                </section>
               ...
               <section id="links">
               	<div id="my-account">
               		...
               		<ul>
               			...
               			<li><a href="order_history.php">Pemesanan</a></li>
